...
public:
	...
	GTvertex();
	GTvertex* find_prevvtx(); // 3/28/2015, added to handle decomposed ASMs, in principle prevSibling should be private and this function provides access to both cases whether prevSibling is NULL or not
	GTvertex* find_nextvtx(); // same as above for nextSibling
	~GTvertex();
};
